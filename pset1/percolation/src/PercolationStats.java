...
public class PercolationStats{
    ...
    {
        if (n <= 0) throw new IllegalArgumentException("input n smaller than 1");
        if (trials <= 0) throw new IllegalArgumentException("input trials smaller than 1");
        this.n = n;
        this.trials = trials;
    ...
    private void trial()  // perform trials independent experiments by the Percolation instance
    {
        ...
        {
            siteMap = new Percolation(this.n);
            ...
            this.listTrialNum[i] = (double) siteMap.numberOfOpenSites()/(n*n);
        }
        // System.out.println("The runtime is: " + watch.elapsedTime());
    }
